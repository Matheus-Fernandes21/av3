...
public class av3login extends JFrame {
	...
	public av3login() {
		...
		private void consulta() {
			String sql = "select * from dbo.cliente where CPF=?";
		try {
		...
		private void adicionar(){
			String sql = "insert into dbo.cliente(CPF,nome_cliente,cidade,rua)values(?,?,?,?)";
		try {
			pst=conexao.prepareStatement(sql);
			pst.setString(1,txtcpf.getText());
		...
		private void alterar(){
			String sql="update dbo.cliente set nome_cliente=?,cidade=?,rua=? where CPF=?";
		...
		String sql="delete from dbo.cliente where CPF=?";
		try {
		pst=conexao.prepareStatement(sql);
		pst.setString(1, txtcpf.getText());
		...
		lblNewLabel_5.setBounds(10, 338, 94, 14);
		...
		lblNewLabel_8.setBounds(218, 338, 46, 14);
		...
		btnNewButton_3 = new JButton("Adicionar Cliente");
		...
		btnNewButton_4 = new JButton("Editar Cliente");
		...
		JButton Consultarbd = new JButton("Consultar Cliente");
